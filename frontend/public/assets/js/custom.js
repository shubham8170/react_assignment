...
// 				$(".append-media").append("<div className='emoji-icon' data-icon="+iconsrc+"><img src="+iconsrc+ "></div>");				
// 			}else{
...
// 			var messageEmojiHtml = '<div className="chat-content user">'+
// 				'<div className="message-item">'+
// 					'<div className="bubble">'+chatEmojiArea+'</div>'+
// 					'<div className="message-time">'+actualTime+'</div>'+
// 				'</div>'+
// 			'</div>';
...
// 			var messageHtml = '<div className="chat-content user">'+
// 				'<div className="message-item">'+
// 					'<div className="bubble">'+chatMessageValue+'</div>'+
// 					'<div className="message-time">'+actualTime+'</div>'+
// 				'</div>'+
// 			'</div>';
